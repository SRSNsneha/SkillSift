...
async function checkUserIdBeforeUpload() {
  ...
  try {
    const res = await fetch(`https://skillsift.onrender.com/check_user_id?user_id=${encodeURIComponent(name_id)}`);
...
async function submitExistingUser() {
  ...
  try {
    const res = await fetch(`https://skillsift.onrender.com/verify_pin?name_id=${encodeURIComponent(name_id)}&pin=${encodeURIComponent(pin)}`);
    const data = await res.json();
...
async function submitNewUser() {
  ...
  try {
    const res = await fetch("https://skillsift.onrender.com/store_user_pin", {
      method: "POST",
...
uploadForm.addEventListener("submit", async (e) => {
  ...
  try {
    const res = await fetch("https://skillsift.onrender.com/store_resume", { method: "POST", body: formData });
    const data = await res.json();
...
analyzeForm.addEventListener("submit", async (e) => {
  ...
  try {
    const verify = await fetch(`https://skillsift.onrender.com/verify_pin?name_id=${encodeURIComponent(name_id)}&pin=${encodeURIComponent(pin)}`);
    ...
    for (const resume of data.results) {
      const downloadRes = await fetch(`https://skillsift.onrender.com/download_resume/${encodeURIComponent(name_id)}/${encodeURIComponent(resume.file_name)}`);
...
clearBtn.addEventListener("click", async () => {
  ...
  try {
    const res = await fetch(`https://skillsift.onrender.com/clear_resumes?name_id=${encodeURIComponent(name_id)}&pin=${encodeURIComponent(pin)}`, {
      method: "DELETE",
    });
